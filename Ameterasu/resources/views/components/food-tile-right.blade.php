...
<div style="justify-content:right; position:relative;" {{$attributes->merge(['class' => ''])}}>
    <div class="container" style="position:relative; margin-top:200px; border-radius: 51px 151px 51px 151px;right:0px">
        <img 
            style="width:100%;border-radius: 50px 150px 50px 150px;" 
            class ="img" 
